...
btn.addEventListener("click", function(event) {
    ...
    const sexo = document.querySelector('#idSexo').value
    const etnia = document.querySelector('#idEtnia').value
    const saude = document.querySelector('#idCartsaude').value
    const escolar = document.querySelector('#idHistescolar').value
    const rne = document.querySelector('#idRNE').value
